      ...
      <div class="modal-body">
        ...
        <div class="d-flex flex-column align-items-start justify-content-center py-2">
          <p class="m-0 fw-bold" style="font-size: 1rem;">
            Charity Request ID: <span class="fw-normal">R1001</span>
          </p>
          <p class="m-0 fw-bold" style="font-size: 1rem;">
            ID Type Used: <span class="fw-normal">Driver's License</span>
          </p>
          <p class="m-0 fw-bold" style="font-size: 1rem;">
            ID Number: <span class="fw-normal">1234567890</span>
          </p>
        </div>
        <div class="d-flex flex-column justify-content-center align-items-start">
          ...
          <img class="img-fluid" style="max-height: 500px; object-fit: cover; border: 3px solid #1b3c53; border-radius: 5px;"  src="/Shanty-Dope-Proj/CareToFund/resources/img/charity-front.jpg" alt="">
        </div>
