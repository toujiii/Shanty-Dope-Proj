    ...
    <div class="container bg-light my-3 px-4 py-2 shadow-sm d-flex align-items-center flex-column" style=" border-radius: 12px; ">
        <div class="d-flex gap-2 w-100 justify-content-between py-2" style="border-bottom: 4px solid #1b3c53;">
            <div class="d-flex gap-3 align-items-center">
                <p class="m-0 fs-4 fw-bold" style="color: #1b3c53;">
                    John Doe is requesting a charity.
                </p>
                <p class="m-0 fs-6" style="color: #1b3c53;">
                    (R1001)
                </p>
            </div>
            <div class="d-flex align-items-center gap-0">
                ...
                <!-- kapag approved you request -->
                <!-- <p class="m-0 text-success fw-bold">
                    Approved
                </p> -->

                <!-- kapag rejected ung request -->
        ...
        <div class="container pb-3 px-0 d-flex align-items-center gap-4">
