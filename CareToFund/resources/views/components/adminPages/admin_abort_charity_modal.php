<!-- Modal -->
<div class="modal fade" id="abortCharityModal" tabindex="-1"  aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class=" d-flex justify-content-center align-items-center gap-3 m-4">
        ...
        <button type="button" class="btn btn-danger  fw-bold" data-bs-toggle="modal" data-bs-target="#abortCharityOK">Abort</button>
      </div>
    </div>
  </div>
</div>

<div class="modal fade" id="abortCharityOK" tabindex="-1"  aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      ...
      <div class="modal-body d-flex flex-column align-items-center text-center gap-2 ">
        ...
        <p class="m-0">
          The charity request has been Aborted.
        </p>
      </div>
      <div class=" d-flex justify-content-center align-items-center gap-3 m-4">
