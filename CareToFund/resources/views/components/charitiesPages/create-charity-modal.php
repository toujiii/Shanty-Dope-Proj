<style>
  ...
  .custom-input:focus {
    ...
    box-shadow: 0 0 8px rgba(27, 60, 83, 0.2);
    /* Soft glow */
  }
...
<div class="modal fade" id="createCharityModal" tabindex="-1" aria-labelledby="createCharityLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content px-3">
      ...
      <div class="modal-header p-2" style="border-bottom: 2px solid #1B3C53;">
            ...
            <div class="row g-3">
              <div class="col-md-6">
                <input type="number" class="form-control custom-input"
                  name="fund_limit" placeholder="Charity Fund limit (₱)" required min="100" max="100000" step="100">
              </div>
              <div class="col-md-6">
                <input type="number" class="form-control custom-input"
                  name="duration" placeholder="Charity Event Duration (Days)" required min="1" max="31" step="1">
              </div>
            </div>
          </div>
